    ...
    <div className="max-w-4xl mx-auto py-20 px-6">
      <div className="bg-white rounded-[3rem] shadow-2xl overflow-hidden border border-teal-50">
        <div className="md:flex">
          {/* Upload Section */}
          <div className="md:w-1/2 p-12 bg-teal-900 text-white">
            ...
            <label className="block w-full border-2 border-dashed border-teal-700 rounded-2xl p-10 text-center cursor-pointer hover:bg-teal-800 transition-colors">
              <input type="file" className="hidden" onChange={handleImageChange} accept="image/*" />
              <div className="text-4xl mb-4">📸</div>
              <span className="font-bold">Select Photo</span>
              <p className="text-xs text-teal-500 mt-2">JPG, PNG up to 10MB</p>
            </label>
            ...
            {preview && (
              <button 
                ...
                disabled={loading}
                className="w-full mt-8 bg-teal-500 text-white py-4 rounded-xl font-bold text-lg hover:bg-teal-400 disabled:opacity-50 transition-all shadow-xl shadow-teal-950"
              >
          ...
          {/* Result Section */}
          <div className="md:w-1/2 p-12 bg-slate-50 flex items-center justify-center">
            {!preview ? (
              ...
              <div className="w-full h-full flex flex-col items-center">
                <div className="relative w-full aspect-[4/5] rounded-3xl overflow-hidden shadow-inner bg-black">
                  ...
                  {result && !loading && (
                    <div className="absolute bottom-6 left-1/2 -translate-x-1/2 bg-teal-600 text-white px-6 py-2 rounded-full font-bold shadow-lg animate-bounce">
                      AI Preview Applied ✨
                    </div>
                  )}
                </div>
